    ...
    <div class="row">
      <div class="col-md-2 col-xs-6">
        <div class="small-box bg-red">
          ...
          <a href="./dashboard-out.php?file_type=<?php echo ('U')?>" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-md-2 col-xs-6">
        <div class="small-box bg-green">
          ...
          <a href="./dashboard-out.php?file_type=<?php echo ('B')?>" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-md-2 col-xs-6">
        <div class="small-box bg-yellow">
          ...
          <a href="./dashboard-out.php?file_type=<?php echo ('K')?>" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-md-2 col-xs-6">
        <div class="small-box bg-aqua">
          <div class="inner">
            <h3> </h3>
            <p>Approved: &nbsp;<?php echo $Approval; ?></p>
          </div>
          <div class="icon">
            <i class="fa fa-battery-1 (alias)"></i>
          </div>
          <a href="./dashboard-out.php?file_type=<?php echo ('A')?>" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-md-2 col-xs-6">
        <div class="small-box bg-navy">
          ...
          <a href="./dashboard-out.php?file_type=<?php echo ('P')?>" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-md-2 col-xs-6">
        <div class="small-box bg-maroon">
          ...
          <a href="./dashboard-out.php?file_type=<?php echo ('M')?>" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
    <?php
}
