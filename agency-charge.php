...
<form name="form1"  id="fileUploadForm"  method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off" action="agency-charge-out.php" target="_blank">
    <div class="row">
        <div class="col-md-12">
