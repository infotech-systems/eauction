                            ...
                            <div class="box-body" >
                                ...
                                <table class="table table-bordered" width="95%">
                                    ...
                                    ?>
                                        ...
                                        <tr> 
                                            <td colspan="6"><B>Offer Sheet No: <?php echo $offersheet;?></B></td>
                                            <td colspan="<?php if($ses_user_type!='B'){ ?> 5 <?php } else { ?>4<?php } ?>" align="right"  style=" border-top:none !important;"><B>Print Date : <?php echo $print_date; ?> Time : <?php echo $print_dt[1]; ?></B></td>
                                        </tr>
                                    </thead> 
                                    <tr>
                                        <td><B>Sl.</B></td>
                                    <!--    <td><B>Lot No</B></td>-->
                                        ...
                                        <td><B>Valuation</B></td>
                                        <td><B>HBP</B></td>
                                        <td><B>Bill Value</B></td>
                                        <td><B>Billing Name</B></td>
                                        <td><B>Bid Price 1</B></td>
                                 ...
                                 //   echo "$sqle $offersheet";
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><B><?php echo $Tkg;?></B></td>
                                        <td colspan="2">&nbsp;</td>
                                        <td align="right"><B><?php echo number_format($Tbill_value,2);?></B></td>
                                        <td colspan="5">&nbsp;</td>
                                    </tr>
